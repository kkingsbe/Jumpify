...
var app = (function () {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div1 = element("div");
    			t2 = text("Ground Track");
    			t3 = space();
    			div2 = element("div");
    			t4 = text("3D Track");
    			attr_dev(div0, "class", div0_class_value = "" + (null_to_empty(/*graphsClass*/ ctx[0]) + " svelte-1lztajk"));
    			add_location(div0, file$8, 47, 4, 1139);
    			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(/*groundTrackClass*/ ctx[1]) + " svelte-1lztajk"));
    			add_location(div1, file$8, 48, 4, 1206);
    			attr_dev(div2, "class", div2_class_value = "" + (null_to_empty(/*track3DClass*/ ctx[2]) + " svelte-1lztajk"));
    			add_location(div2, file$8, 49, 4, 1289);
    			attr_dev(modeSelect, "class", "svelte-1lztajk");
    			add_location(modeSelect, file$8, 46, 0, 1121);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			dispose = [
    				listen_dev(div0, "click", /*selectGraphs*/ ctx[3], false, false, false),
    				listen_dev(div1, "click", /*selectGroundTrack*/ ctx[4], false, false, false),
    				listen_dev(div2, "click", /*selectTrack3D*/ ctx[5], false, false, false)
    			];
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*graphsClass*/ 1 && div0_class_value !== (div0_class_value = "" + (null_to_empty(/*graphsClass*/ ctx[0]) + " svelte-1lztajk"))) {
    				attr_dev(div0, "class", div0_class_value);
    			}

    			if (dirty & /*groundTrackClass*/ 2 && div1_class_value !== (div1_class_value = "" + (null_to_empty(/*groundTrackClass*/ ctx[1]) + " svelte-1lztajk"))) {
    				attr_dev(div1, "class", div1_class_value);
    			}

    			if (dirty & /*track3DClass*/ 4 && div2_class_value !== (div2_class_value = "" + (null_to_empty(/*track3DClass*/ ctx[2]) + " svelte-1lztajk"))) {
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	function selectGraphs() {
    		...
    		$$invalidate(6, selectedMode = "graphs");
    		$$invalidate(0, graphsClass = "mode selected");
    		$$invalidate(1, groundTrackClass = "mode");
    		$$invalidate(2, track3DClass = "mode");
    	}
    	...
    	function selectGroundTrack() {
    		...
    		track3DSelected = false;
    		$$invalidate(6, selectedMode = "ground track");
    		$$invalidate(0, graphsClass = "mode");
    		$$invalidate(1, groundTrackClass = "mode selected");
    		$$invalidate(2, track3DClass = "mode");
    	}
    	...
    	function selectTrack3D() {
    		...
    		$$invalidate(6, selectedMode = "track 3d");
    		$$invalidate(0, graphsClass = "mode");
    		$$invalidate(1, groundTrackClass = "mode");
    		$$invalidate(2, track3DClass = "mode selected");
    	}

    	const writable_props = ["selectedMode"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Display_mode_select> was created with unknown prop '${key}'`);
    	});

    	$$self.$set = $$props => {
    		if ("selectedMode" in $$props) $$invalidate(6, selectedMode = $$props.selectedMode);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		if ("selectedMode" in $$props) $$invalidate(6, selectedMode = $$props.selectedMode);
    		if ("graphsSelected" in $$props) graphsSelected = $$props.graphsSelected;
    		if ("groundTrackSelected" in $$props) groundTrackSelected = $$props.groundTrackSelected;
    		if ("track3DSelected" in $$props) track3DSelected = $$props.track3DSelected;
    		if ("graphsClass" in $$props) $$invalidate(0, graphsClass = $$props.graphsClass);
    		if ("groundTrackClass" in $$props) $$invalidate(1, groundTrackClass = $$props.groundTrackClass);
    		if ("track3DClass" in $$props) $$invalidate(2, track3DClass = $$props.track3DClass);
    	};
    ...
    class Display_mode_select extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { selectedMode: 6 });
    		...
    		if (/*selectedMode*/ ctx[6] === undefined && !("selectedMode" in props)) {
    			console.warn("<Display_mode_select> was created without expected prop 'selectedMode'");
    		}
    	}

    	get selectedMode() {
    		throw new Error("<Display_mode_select>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set selectedMode(value) {
    		throw new Error("<Display_mode_select>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    const file$9 = "node_modules\\svelte-chartjs\\src\\Base.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas, file$9, 41, 0, 782);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Base extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$9, create_fragment$9, safe_not_equal, { data: 2, type: 3, options: 4 });
    ...
    const file$a = "src\\components\\altgraph.svelte";

    // (52:4) {#if typeof(jump) !== "undefined"}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "container svelte-1d50z85");
    			add_location(div, file$a, 52, 4, 1499);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(52:4) {#if typeof(jump) !== \\\"undefined\\\"}",
    		ctx
    	});
    ...
    function create_fragment$b(ctx) {
    	let graph;
    	let current;
    	let if_block = typeof /*jump*/ ctx[0] !== "undefined" && create_if_block$1(ctx);

    	const block = {
    		c: function create() {
    			graph = element("graph");
    			if (if_block) if_block.c();
    			add_location(graph, file$a, 50, 0, 1446);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Altgraph> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("datapoints" in $$props) $$invalidate(3, datapoints = $$props.datapoints);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*jump, labels, datapoints*/ 13) {
    			 if (typeof jump !== "undefined") {
    				//console.log(jump)
    				let startSec;

    				$$invalidate(2, labels = []);
    				$$invalidate(3, datapoints = []);
    ...
    class Altgraph extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$b, create_fragment$b, safe_not_equal, { jump: 0 });
    		...
    		if (/*jump*/ ctx[0] === undefined && !("jump" in props)) {
    			console.warn("<Altgraph> was created without expected prop 'jump'");
    		}
    	}
    ...
    const file$b = "src\\components\\VSGraph.svelte";

    // (75:4) {#if typeof(jump) !== "undefined"}
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(line.$$.fragment);
    			attr_dev(div, "class", "container svelte-1d50z85");
    			add_location(div, file$b, 75, 4, 2125);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(line, div, null);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(75:4) {#if typeof(jump) !== \\\"undefined\\\"}",
    		ctx
    	});
    ...
    function create_fragment$c(ctx) {
    	let graph;
    	let current;
    	let if_block = typeof /*jump*/ ctx[0] !== "undefined" && create_if_block$2(ctx);

    	const block = {
    		c: function create() {
    			graph = element("graph");
    			if (if_block) if_block.c();
    			add_location(graph, file$b, 73, 0, 2072);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<VSGraph> was created with unknown prop '${key}'`);
    	});
    ...
    class VSGraph extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$c, create_fragment$c, safe_not_equal, { jump: 0 });
    		...
    		if (/*jump*/ ctx[0] === undefined && !("jump" in props)) {
    			console.warn("<VSGraph> was created without expected prop 'jump'");
    		}
    	}
    ...
    /* src\components\HSGraph.svelte generated by Svelte v3.19.1 */
    const file$c = "src\\components\\HSGraph.svelte";

    // (56:4) {#if typeof(jump) !== "undefined"}
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(line.$$.fragment);
    			attr_dev(div, "class", "container svelte-1d50z85");
    			add_location(div, file$c, 56, 4, 1600);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(line, div, null);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(56:4) {#if typeof(jump) !== \\\"undefined\\\"}",
    		ctx
    	});
    ...
    function create_fragment$d(ctx) {
    	let graph;
    	let current;
    	let if_block = typeof /*jump*/ ctx[0] !== "undefined" && create_if_block$3(ctx);

    	const block = {
    		c: function create() {
    			graph = element("graph");
    			if (if_block) if_block.c();
    			add_location(graph, file$c, 54, 0, 1547);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$d($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<HSGraph> was created with unknown prop '${key}'`);
    	});
    ...
    class HSGraph extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$d, create_fragment$d, safe_not_equal, { jump: 0 });
    		...
    		if (/*jump*/ ctx[0] === undefined && !("jump" in props)) {
    			console.warn("<HSGraph> was created without expected prop 'jump'");
    		}
    	}

    	get jump() {
    		throw new Error("<HSGraph>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set jump(value) {
    		throw new Error("<HSGraph>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src\components\jump-graphs.svelte generated by Svelte v3.19.1 */
    const file$d = "src\\components\\jump-graphs.svelte";
    ...
    function create_fragment$e(ctx) {
    	...
    	if (/*jump*/ ctx[0] !== void 0) {
    		hsgraph_props.jump = /*jump*/ ctx[0];
    	}

    	const hsgraph = new HSGraph({ props: hsgraph_props, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(graphs, file$d, 7, 0, 178);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$e($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ jump, Altgraph, VSGraph, HSGraph });
    	...
    	return [jump, altgraph_jump_binding, vsgraph_jump_binding, hsgraph_jump_binding];
    }

    class Jump_graphs extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$e, create_fragment$e, safe_not_equal, { jump: 0 });
    ...
    const file$e = "src\\components\\jumps.svelte";

    // (38:4) {#if selectedMode == "graphs"}
    function create_if_block$4(ctx) {
    	let current;

    	const jumpgraphs = new Jump_graphs({
    			props: { jump: /*selectedData*/ ctx[2] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			mount_component(jumpgraphs, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const jumpgraphs_changes = {};
    			if (dirty & /*selectedData*/ 4) jumpgraphs_changes.jump = /*selectedData*/ ctx[2];
    		...
    		d: function destroy(detaching) {
    			destroy_component(jumpgraphs, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(38:4) {#if selectedMode == \\\"graphs\\\"}",
    		ctx
    	});
    ...
    function create_fragment$f(ctx) {
    	...
    	let t0;
    	let updating_selectedMode;
    	let t1;
    	let current;

    	function jumpselector_selectedJump_binding(value) {
    		/*jumpselector_selectedJump_binding*/ ctx[7].call(null, value);
    	}

    	let jumpselector_props = {};

    	if (/*selectedJump*/ ctx[1] !== void 0) {
    		jumpselector_props.selectedJump = /*selectedJump*/ ctx[1];
    	}
    	...
    	function modeselect_selectedMode_binding(value) {
    		/*modeselect_selectedMode_binding*/ ctx[8].call(null, value);
    	}

    	let modeselect_props = {};

    	if (/*selectedMode*/ ctx[0] !== void 0) {
    		modeselect_props.selectedMode = /*selectedMode*/ ctx[0];
    	}

    	const modeselect = new Display_mode_select({ props: modeselect_props, $$inline: true });
    	binding_callbacks.push(() => bind(modeselect, "selectedMode", modeselect_selectedMode_binding));
    	let if_block = /*selectedMode*/ ctx[0] == "graphs" && create_if_block$4(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(jumps, file$e, 34, 0, 939);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(jumps, t1);
    			if (if_block) if_block.m(jumps, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			const jumpselector_changes = {};

    			if (!updating_selectedJump && dirty & /*selectedJump*/ 2) {
    				updating_selectedJump = true;
    				jumpselector_changes.selectedJump = /*selectedJump*/ ctx[1];
    				add_flush_callback(() => updating_selectedJump = false);
    			}

    			jumpselector.$set(jumpselector_changes);
    			const modeselect_changes = {};

    			if (!updating_selectedMode && dirty & /*selectedMode*/ 1) {
    				updating_selectedMode = true;
    				modeselect_changes.selectedMode = /*selectedMode*/ ctx[0];
    				add_flush_callback(() => updating_selectedMode = false);
    			}

    			modeselect.$set(modeselect_changes);

    			if (/*selectedMode*/ ctx[0] == "graphs") {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    					transition_in(if_block, 1);
    				} else {
    ...
    function instance$f($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("selectedMode" in $$props) $$invalidate(0, selectedMode = $$props.selectedMode);
    		if ("Datastore" in $$props) Datastore = $$props.Datastore;
    		if ("db" in $$props) $$invalidate(6, db = $$props.db);
    		if ("selectedJump" in $$props) $$invalidate(1, selectedJump = $$props.selectedJump);
    		if ("selectedData" in $$props) $$invalidate(2, selectedData = $$props.selectedData);
    		if ("dbLoaded" in $$props) $$invalidate(3, dbLoaded = $$props.dbLoaded);
    	...
    	return [
    		...
    		modeselect_selectedMode_binding
    	];
    }
    ...
    const file$f = "src\\components\\import.svelte";
    ...
    function create_fragment$h(ctx) {
    	...
    	let if_block2 = /*page*/ ctx[0] == 3 && create_if_block$5(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-hq7p2");
    			add_location(main, file$g, 9, 0, 254);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
